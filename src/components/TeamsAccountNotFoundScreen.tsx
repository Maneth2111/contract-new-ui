  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-6 py-12 relative overflow-hidden">
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
        <div className="absolute w-72 h-72 rounded-full bg-blue-50/80 -translate-y-24" />
        <div className="absolute w-40 h-40 rounded-full bg-sky-100/60 translate-x-32 translate-y-20" />
        <div className="absolute w-3 h-3 rounded-full bg-blue-200/90 -translate-x-40 -translate-y-32" />
        <div className="absolute w-2 h-2 rounded-full bg-blue-300/80 translate-x-48 -translate-y-8" />
        <div className="absolute text-blue-200/40 text-2xl font-light -translate-x-52 translate-y-28 select-none">
          +
        </div>
      </div>

      <div className="relative w-full max-w-md text-center">
        <div className="mx-auto mb-8 flex h-36 w-36 items-center justify-center rounded-full bg-linear-to-br from-sky-100 to-blue-100 ring-1 ring-blue-200/60">
